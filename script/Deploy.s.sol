...
/**
 * @title DeployDrawdownCap
 * @notice Deploys DrawdownCap deterministically to any chain with a Uniswap v4 `PoolManager`.
 *
 ...
 */
contract DeployDrawdownCap is Script {
    ...
    function run() external {
        ...
        bytes memory creationCode = type(DrawdownCapHook).creationCode;
        ...
        console2.log("DrawdownCap ", predicted);
        ...
        require(
            keccak256(bytes(IHookMetadata(address(hook)).hookName())) == keccak256(bytes("DrawdownCap")),
